...
@NgModule({
  ...
  exports: [FormsModule, ReactiveFormsModule, HeaderComponent, FooterComponent, BaseLayoutComponent, FeatureComponent, LoaderComponent, SidenavComponent, ...commonModules]
})
